//Redirect to signup.php when register_user's function is clicked
register_user = () =>
{
...
//Redirect to login.php when login_user's function is clicked
login_user = () =>
{
...
//Toogle eye button to view and hide password
viewPasswords = () =>
{
	var passwordInputs = document.getElementById('password');
	var passStatuss = document.getElementById('pass_status');
 
	if (passwordInputs.type == 'password')
	{
		passwordInputs.type='text';
		passStatuss.className='fa fa-eye';
	}
	else
	{
		passwordInputs.type='password';
		passStatuss.className='fa fa-eye-slash';
	}
}
